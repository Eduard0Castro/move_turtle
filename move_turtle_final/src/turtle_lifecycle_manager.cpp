...
class TurtleLifecycleManager : public rclcpp::Node{

    public:

        TurtleLifecycleManager() : rclcpp::Node("turtle_manager"){
            ...
            RCLCPP_INFO(this->get_logger(), "Turtle Lifecycle Manager has been started");
...
int main(int argc, char ** argv){
    ...
    try{
        auto manager = std::make_shared<TurtleLifecycleManager>();
        rclcpp::executors::SingleThreadedExecutor executor;
        manager->initialize_sequence();
        ...
        std::cout << "An exception has occured: " << ex.what() << std::endl;
    }
